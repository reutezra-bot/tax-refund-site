        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 mt-4 text-sm text-[#25D366] hover:text-[#20ba5a] font-medium transition-colors"
            >
          ...
          {/* Links */}
          <div>
            <h3 className="text-white font-semibold mb-3 text-sm">ניווט</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/" className="hover:text-white transition-colors">דף הבית</Link>
              </li>
              <li>
                <Link href="/check" className="hover:text-white transition-colors">התחלת בדיקה</Link>
              </li>
              <li>
          ...
          {/* Legal */}
          <div>
            <h3 className="text-white font-semibold mb-3 text-sm">מסמכים משפטיים</h3>
            <ul className="space-y-2 text-sm">
              <li>
